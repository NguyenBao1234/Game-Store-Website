...
{
    /// <inheritdoc />
    public partial class InitializeDbWithModelsAndIndentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TittleImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    bPublic = table.Column<bool>(type: "bit", nullable: false),
                    TrailerUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ItchioUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SteamUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EpicUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FabUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameCategory", x => x.GameId);
                    table.ForeignKey(
